...
CREATE TABLE [dbo].[conveyances] (
    ...
    [distance] INT NOT NULL CONSTRAINT [conveyances_distance_df] DEFAULT 0,
...
-- AddForeignKey
ALTER TABLE [dbo].[conveyances] ADD CONSTRAINT [conveyances_vehicleTypeId_fkey] FOREIGN KEY ([vehicleTypeId]) REFERENCES [dbo].[vehicleTypes]([id]) ON DELETE NO ACTION ON UPDATE CASCADE;
